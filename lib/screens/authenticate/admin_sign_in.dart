...
class _AdminLogINState extends State<AdminLogIN> {
  ...
  // text field state
  String email = 'hanan2000@cis.asu.edu.eg';
  String password = '2000170573';
  String error = '';
                       ...
                       child: RaisedButton(
                         ...
                         onPressed: () async{
                           if (formkey.currentState.validate()){
                             ...
                             if (result == '6jC9jPa5uLVv2DVoS6MF42rfeD83'){
                 ...
                 child: RaisedButton(
                   ...
                   onPressed: () async {
                     if (formkey.currentState.validate()){
                       ...
                       result = '6jC9jPa5uLVv2DVoS6MF42rfeD83';
                       if (result == null){
                           setState((){
                           error = 'could not sign in with those credentials';
                           loading = false;
                      ...
                      //=> print('Login Button Pressed'),
                     // dynamic result = await _auth.createUserWithEmailAndPassword(name, email, password);
                      //if (result == null){},
                    },
                   padding: EdgeInsets.all(15.0),
                   shape: RoundedRectangleBorder(
